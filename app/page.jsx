            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Say goodbye to long queues and confusing paperwork. With
                  Medimeet, managing your health is as easy as a tap. Book
                  appointments, consult top doctors online, access
                  prescriptions, and track your medical records—all in one
                  place. Join thousands who’ve made the smart switch to
                  stress-free healthcare. Start your journey to better health
                  today.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
